...
class DirectorWorddatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.DirectorWord.btn.edit')
         ->addColumn('delete', 'Admin.DirectorWord.btn.delete')
         ->addColumn('checkbox', 'Admin.DirectorWord.btn.checkbox')
        ->addColumn('DirectorWord_name_'.session('lang'), 'Admin.DirectorWord.btn.DirectorWord')
        ->addColumn('title_name_'.session('lang'), 'Admin.DirectorWord.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','DirectorWord_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(DirectorWord $model)
    {
        return DirectorWord::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'DirectorWord_name_'.session('lang'),
                'data'=> 'DirectorWord_name_'.session('lang'),
               'title'=>trans('admin.DirectorWord_name_'.session('lang')),
