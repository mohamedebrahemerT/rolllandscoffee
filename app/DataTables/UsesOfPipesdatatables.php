...
class UsesOfPipesdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.UsesOfPipes.btn.edit')
         ->addColumn('delete', 'Admin.UsesOfPipes.btn.delete')
         ->addColumn('checkbox', 'Admin.UsesOfPipes.btn.checkbox')
        ->addColumn('UsesOfPipes_name_'.session('lang'), 'Admin.UsesOfPipes.btn.UsesOfPipes')
        ->addColumn('title_name_'.session('lang'), 'Admin.UsesOfPipes.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','UsesOfPipes_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(UsesOfPipes $model)
    {
        return UsesOfPipes::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'UsesOfPipes_name_'.session('lang'),
                'data'=> 'UsesOfPipes_name_'.session('lang'),
               'title'=>trans('admin.UsesOfPipes_name_'.session('lang')),
