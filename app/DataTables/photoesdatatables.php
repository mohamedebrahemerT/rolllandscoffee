...
class photoesdatatables extends DataTable

{
...

    {
        ...
        ->addColumn('edit', 'Admin.photoes.btn.edit')

         ->addColumn('delete', 'Admin.photoes.btn.delete')

         ->addColumn('checkbox', 'Admin.photoes.btn.checkbox')
    ...
    public function query(photoes $model)

    {

        return photoes::query();
