...
class WarrantyQualitydatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.WarrantyQuality.btn.edit')
         ->addColumn('delete', 'Admin.WarrantyQuality.btn.delete')
         ->addColumn('checkbox', 'Admin.WarrantyQuality.btn.checkbox')
        ->addColumn('WarrantyQuality_name_'.session('lang'), 'Admin.WarrantyQuality.btn.WarrantyQuality')
        ->addColumn('title_name_'.session('lang'), 'Admin.WarrantyQuality.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','WarrantyQuality_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(WarrantyQuality $model)
    {
        return WarrantyQuality::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'WarrantyQuality_name_'.session('lang'),
                'data'=> 'WarrantyQuality_name_'.session('lang'),
               'title'=>trans('admin.WarrantyQuality_name_'.session('lang')),
