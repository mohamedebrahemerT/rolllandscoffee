...
class RawMaterialsdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.RawMaterials.btn.edit')
         ->addColumn('delete', 'Admin.RawMaterials.btn.delete')
         ->addColumn('checkbox', 'Admin.RawMaterials.btn.checkbox')
        ->addColumn('RawMaterials_name_'.session('lang'), 'Admin.RawMaterials.btn.RawMaterials')
        ->addColumn('title_name_'.session('lang'), 'Admin.RawMaterials.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','RawMaterials_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(RawMaterials $model)
    {
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'RawMaterials_name_'.session('lang'),
                'data'=> 'RawMaterials_name_'.session('lang'),
               'title'=>trans('admin.RawMaterials_name_'.session('lang')),
