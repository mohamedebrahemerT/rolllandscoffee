...
class Ourworksdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.Ourworks.btn.edit')
         ->addColumn('delete', 'Admin.Ourworks.btn.delete')
         ->addColumn('checkbox', 'Admin.Ourworks.btn.checkbox')
        ->addColumn('Ourworks_name_'.session('lang'), 'Admin.Ourworks.btn.Ourworks')
        ->addColumn('title_name_'.session('lang'), 'Admin.Ourworks.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','Ourworks_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(Ourworks $model)
    {
        return Ourworks::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'Ourworks_name_'.session('lang'),
                'data'=> 'Ourworks_name_'.session('lang'),
               'title'=>trans('admin.Ourworks_name_'.session('lang')),
