...
class Healthyoptiondatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.Healthyoption.btn.edit')
         ->addColumn('delete', 'Admin.Healthyoption.btn.delete')
         ->addColumn('checkbox', 'Admin.Healthyoption.btn.checkbox')
        ->addColumn('Healthyoption_name_'.session('lang'), 'Admin.Healthyoption.btn.Healthyoption')
        ->addColumn('title_name_'.session('lang'), 'Admin.Healthyoption.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','Healthyoption_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(Healthyoption $model)
    {
        return Healthyoption::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'Healthyoption_name_'.session('lang'),
                'data'=> 'Healthyoption_name_'.session('lang'),
               'title'=>trans('admin.Healthyoption_name_'.session('lang')),
