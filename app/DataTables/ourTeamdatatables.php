...
class ourTeamdatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
     ...
     ->addColumn('jobTitle_name_'.session('lang'), 'Admin.ourTeam.btn.jobTitle')
        ...
        ->rawColumns([
            'edit','delete','checkbox','jobTitle_name_'.session('lang'),
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
                 'name'=> 'jobTitle_name_'.session('lang'),
                'data'=> 'jobTitle_name_'.session('lang'),
               'title'=>trans('admin.jobTitle_name_'.session('lang')),

            ],

             [
                 'name'=> 'name_name_'.session('lang'),
                'data'=> 'name_name_'.session('lang'),
               'title'=>trans('admin.name_name_'.session('lang')),

            ],
             [
                 'name'=> 'desc_name_'.session('lang'),
                'data'=> 'desc_name_'.session('lang'),
               'title'=>trans('admin.desc_name_'.session('lang')),
