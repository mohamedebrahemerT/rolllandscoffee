...
class AdvantagesOfPipesdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.AdvantagesOfPipes.btn.edit')
         ->addColumn('delete', 'Admin.AdvantagesOfPipes.btn.delete')
         ->addColumn('checkbox', 'Admin.AdvantagesOfPipes.btn.checkbox')
        ->addColumn('AdvantagesOfPipes_name_'.session('lang'), 'Admin.AdvantagesOfPipes.btn.AdvantagesOfPipes')
        ->addColumn('title_name_'.session('lang'), 'Admin.AdvantagesOfPipes.btn.title')

        

        ->rawColumns([
            'edit','delete','checkbox','AdvantagesOfPipes_name_'.session('lang'),'title_name_'.session('lang'),
        ]);
     ...
     */
    public function query(AdvantagesOfPipes $model)
    {
        return AdvantagesOfPipes::query();
    }
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
              ...
              [
                 'name'=> 'AdvantagesOfPipes_name_'.session('lang'),
                'data'=> 'AdvantagesOfPipes_name_'.session('lang'),
               'title'=>trans('admin.AdvantagesOfPipes_name_'.session('lang')),
