...
class statesdatatables extends DataTable
{
    ...
    {
        return states::query()->with('country_id')->with('city_id');
    }
    ...
    public function html()
    {
        ...
        ['text'=>'<i class="fa fa-plus"></i>'.trans('admin.states_add'),'className'=>'btn btn-success' ,'action'=>"function(){
    ...
    protected function getColumns()
    {
           ...
           return [
            ...
            [
                 'name'=> 'states_name_en',
                'data'=> 'states_name_en',
               'title'=>trans('admin.states_name_en'),

            ],
             [


                 'name'=> 'city_id.cities_name_en',
                'data'=> 'city_id.cities_name_en',
              ...
              [
                ...
                'data'=> 'country_id.countries_name_'.'en',
