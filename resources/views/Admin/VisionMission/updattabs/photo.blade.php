  ...
  <script type="text/javascript">   
         ...
         $('#dropzone_main_photo').dropzone({
            ...
            url:'{{ url("admin/update_img_dropzon_VisionMission/img/".$VisionMission->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:0,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/delete_img_dropzon_VisionMission/img/".$VisionMission->id)}}',
                data:{
                  _token:'{{ csrf_token() }}',
                },
           ...
           return (fmock = file.previewElement) != null ? fmock.parentNode.removeChild(file.previewElement) : void 0;
            ...
            init:function()
            {
                ...
                @if (!empty($VisionMission->photo))
               var mock={
                name:'{{ $VisionMission->id }}',
                size:'',
                type:'',
                id:' ',
               };
               this.emit('addedfile',mock);
this.options.thumbnail.call(this,mock,"{{Storage::url($VisionMission->photo)}}" );
               $('.dz-progress').remove();
               @endif
