   <div id="home" class="tab-pane fade in active">
      <h3>{{trans('admin.VisionMission_name_en')}}</h3>
...
"></i>
              ...
              <h3 class="box-title">{{trans('admin.VisionMission_name_en')}}</h3>
              <!-- tools box -->
            ...
            <div class="box-body">  
                <div>
                  <textarea name="VisionMission_name_en" class="form-control VisionMission_name_en" >{{$VisionMission->VisionMission_name_en}}</textarea>
                </div>
