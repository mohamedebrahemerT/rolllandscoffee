  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            ...
            <div class="box-body">
                       ...
                       {!! Form::open(array('url' => 'admin/admins/'.$admin->id,'method'=>'put', 'id' => 'fromdata')) !!}
                     <div class="form-group"> 
                     {{ Form::label('name', trans('admin.adminname'))  }}
                    {{ Form::text('name',$admin->name,['class'=>'form-control'] ,old('name'))  }}
                     </div> 
                       <div class="form-group"> 
                     {{ Form::label('email', trans('admin.adminemail'))  }}
                    {{ Form::text('email',$admin->email,['class'=>'form-control'],old('email'))  }}
                     </div> 
                        <div class="form-group"> 
