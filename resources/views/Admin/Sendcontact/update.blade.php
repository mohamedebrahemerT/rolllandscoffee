     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Sendcontact','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.Sendcontact.updattabs.Sendcontact_name_en')
              @include('Admin.Sendcontact.updattabs.Sendcontact_name_es')
          @include('Admin.Sendcontact.updattabs.Sendcontact_name_fr')
          @include('Admin.Sendcontact.updattabs.Sendcontact_name_it')
          @include('Admin.Sendcontact.updattabs.Sendcontact_name_ru')
          @include('Admin.Sendcontact.updattabs.photo')
               <div class="form-group"> 
