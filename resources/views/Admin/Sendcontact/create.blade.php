    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.Sendcontact_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Sendcontact_name_es')}}</a></li>

    <li><a data-toggle="tab" href="#menu1"><i class="fa fa-gear"></i> {{trans('admin.Sendcontact_name_fr')}}</a></li>

    
    <li><a data-toggle="tab" href="#menu3"><i class="fa fa-file"></i> {{trans('admin.Sendcontact_name_it')}}</a></li>
    <li><a data-toggle="tab" href="#menu4"><i class="fa fa-info"></i> {{trans('admin.Sendcontact_name_ru')}}</a></li>
     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Sendcontact','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.Sendcontact.tabs.Sendcontact_name_en')
              @include('Admin.Sendcontact.tabs.Sendcontact_name_es')
          @include('Admin.Sendcontact.tabs.Sendcontact_name_fr')
          @include('Admin.Sendcontact.tabs.Sendcontact_name_it')
          @include('Admin.Sendcontact.tabs.Sendcontact_name_ru')
          @include('Admin.Sendcontact.tabs.photo')
               <div class="form-group"> 
