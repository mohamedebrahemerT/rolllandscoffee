  ...
  <script type="text/javascript">   
         ...
         $('#dropzone_main_photo').dropzone({
            ...
            url:'{{ url("admin/update_img_dropzon_FAQs/img/".$FAQs->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:0,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/delete_img_dropzon_FAQs/img/".$FAQs->id)}}',
                data:{
                  _token:'{{ csrf_token() }}',
                },
...
this.options.thumbnail.call(this,mock,"{{Storage::url($FAQs->photo)}}" );
               $('.dz-progress').remove();
               @endif
