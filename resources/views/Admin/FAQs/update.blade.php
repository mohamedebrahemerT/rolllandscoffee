...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'FAQs_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'FAQs_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var FAQs_name_en = $('.FAQs_name_en').val();
          var FAQs_name_ar = $('.FAQs_name_ar').val();  
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "FAQs_name_en": FAQs_name_en,
        "FAQs_name_ar": FAQs_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.FAQs_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/FAQs','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.FAQs.updattabs.FAQs_name_en')
              @include('Admin.FAQs.updattabs.FAQs_name_ar')
        
          @include('Admin.FAQs.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/FAQs/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
