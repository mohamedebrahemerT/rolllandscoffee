...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">rest with token retrive</p>

    <form action="{{url('admin_reset_pass_add_new_post')}}/{{$check_token->token}}" method="post">
      @csrf
     
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Email" name="email" value="{{ $check_token->email}}">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">retrive</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
