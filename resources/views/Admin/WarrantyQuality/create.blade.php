 ...
 @push('js')
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.WarrantyQuality') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.WarrantyQuality_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.WarrantyQuality_name_es')}}</a></li>

    <li><a data-toggle="tab" href="#menu1"><i class="fa fa-gear"></i> {{trans('admin.WarrantyQuality_name_fr')}}</a></li>

    
    <li><a data-toggle="tab" href="#menu3"><i class="fa fa-file"></i> {{trans('admin.WarrantyQuality_name_it')}}</a></li>
    <li><a data-toggle="tab" href="#menu4"><i class="fa fa-info"></i> {{trans('admin.WarrantyQuality_name_ru')}}</a></li>
     ...
     <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/WarrantyQuality','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.WarrantyQuality.tabs.WarrantyQuality_name_en')
              @include('Admin.WarrantyQuality.tabs.WarrantyQuality_name_es')
          @include('Admin.WarrantyQuality.tabs.WarrantyQuality_name_fr')
          @include('Admin.WarrantyQuality.tabs.WarrantyQuality_name_it')
          @include('Admin.WarrantyQuality.tabs.WarrantyQuality_name_ru')
          @include('Admin.WarrantyQuality.tabs.photo')
               <div class="form-group"> 
