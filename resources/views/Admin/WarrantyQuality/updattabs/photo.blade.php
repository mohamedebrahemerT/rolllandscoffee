  ...
  <script type="text/javascript">   
         ...
         $('#dropzone_main_photo').dropzone({
            ...
            url:'{{ url("admin/update_img_dropzon_WarrantyQuality/img/".$WarrantyQuality->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:0,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/delete_img_dropzon_WarrantyQuality/img/".$WarrantyQuality->id)}}',
                data:{
                  _token:'{{ csrf_token() }}',
                },
           ...
           return (fmock = file.previewElement) != null ? fmock.parentNode.removeChild(file.previewElement) : void 0;
            ...
            init:function()
            {
                ...
                @if (!empty($WarrantyQuality->photo))
               var mock={
                name:'{{ $WarrantyQuality->id }}',
                size:'',
                type:'',
                id:' ',
               };
               this.emit('addedfile',mock);
this.options.thumbnail.call(this,mock,"{{Storage::url($WarrantyQuality->photo)}}" );
               $('.dz-progress').remove();
               @endif
