...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'WarrantyQuality_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'WarrantyQuality_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var WarrantyQuality_name_en = $('.WarrantyQuality_name_en').val();
          var WarrantyQuality_name_ar = $('.WarrantyQuality_name_ar').val();  
              ...
              url:'{{ url('admin/WarrantyQuality')}}/{{$WarrantyQuality->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "WarrantyQuality_name_en": WarrantyQuality_name_en,
        "WarrantyQuality_name_ar": WarrantyQuality_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.WarrantyQuality_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/WarrantyQuality','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.WarrantyQuality.updattabs.WarrantyQuality_name_en')
              @include('Admin.WarrantyQuality.updattabs.WarrantyQuality_name_ar')
        
          @include('Admin.WarrantyQuality.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/WarrantyQuality/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
