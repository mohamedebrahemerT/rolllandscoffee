...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'subcategories_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'subcategories_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var Maincategories_id = $('.Maincategories_id').val();
          var measure_name_ar = $('.measure_name_ar').val();
          var measure_name_en = $('.measure_name_en').val();
             

            
          var subcategories_name_en = $('.subcategories_name_en').val();
          var subcategories_name_ar = $('.subcategories_name_ar').val();
       
        
   
               $.ajax({
                
              url:'{{ url('admin/subcategories')}}/{{$subcategories->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "subcategories_name_en": subcategories_name_en,
        "subcategories_name_ar": subcategories_name_ar,
        "Maincategories_id": Maincategories_id,
        "measure_name_ar": measure_name_ar,
        "measure_name_en": measure_name_en,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.subcategories') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.subcategories_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.subcategories_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/subcategories','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.subcategories.updattabs.subcategories_name_en')
              @include('Admin.subcategories.updattabs.subcategories_name_ar')
        
          @include('Admin.subcategories.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/subcategories/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
