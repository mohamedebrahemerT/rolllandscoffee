 ...
 @push('js')
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
          ...
          {{  Form::open(['url'=>'admin/states/'.$states->id,'method'=>'put','files'=>true] ) }}
                     <div class="form-group"> 
  {{ Form::label('states_name_ar', trans('admin.states_name_ar'))  }}
                    {{ Form::text('states_name_ar',$states->states_name_ar,['class'=>'form-control'])  }}
                     </div> 
                       <div class="form-group"> 
                     {{ Form::label('states_name_en', trans('admin.states_name_en'))  }}
                    {{ Form::text('states_name_en',$states->states_name_en,['class'=>'form-control'])  }}
                     </div> 
                      
                       <div class="form-group"> 
                     {{ Form::label('country_id', trans('admin.country_id'))  }}
{{ Form::select('country_id',App\countries::pluck('countries_name_en','id'),$states->country_id,['class'=>'form-control country_id',"placeholder"=>"........"] )  }}
                     </div> 
                                                           <div class="form-group"> 
