...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'Ourworks_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'Ourworks_name_ar' , {
        language: '{{session('lang')}}',
});
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Ourworks_name_arr')}}</a></li>
