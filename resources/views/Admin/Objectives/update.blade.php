 ...
 @push('js')
        ...
        language: '{{session('lang')}}',
          ...
          var title_name_ar = $('.title_name_ar').val();   
           ...
           var Objectives_name_en = $('.Objectives_name_en').val();
          var Objectives_name_ar = $('.Objectives_name_ar').val();       
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.Objectives_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Objectives_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Objectives','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Objectives/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
