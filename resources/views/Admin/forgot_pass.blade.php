...
@endif
    ...
    <p class="login-box-msg">reset your password  it is  easy </p>

    <form action="{{url('admin_reset_pass')}}" method="post">
      {{ csrf_field() }}
    ...
    <a href="{{url('admin_login')}}" class="text-center">Register a new membership</a>
