    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.ourTeam_name_arr')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/ourTeam','files'=>true,'id'=>'save_from_data'] ) }}
        ...
        @include('Admin.ourTeam.updattabs.ourTeam_name_en')
              @include('Admin.ourTeam.updattabs.ourTeam_name_ar')
