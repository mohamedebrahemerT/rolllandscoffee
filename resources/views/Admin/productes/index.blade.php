...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
         ...
         <select class="form-group form-control " style="padding: 3px"  onchange="location = this.value;">

          <option>--فلتر   بالتصنيف --</option>
...
selected
            ...
            value="{{url('/')}}/admin/productes?department_id={{$department->id}}" > {{$department->dep_name_ar}} </option>
           @endforeach
