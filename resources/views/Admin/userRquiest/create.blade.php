  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            ...
            <div class="box-body">
                    ...
                    {{  Form::open(['route'=>'userRquiest.store']) }}
                     <div class="form-group"> 
            ...
            {!! Form::select('level', [null => trans('admin.level')] + ['user' => trans('admin.user'),'vendor'=>trans('admin.vendor'),'company'=>trans('admin.company')], null, ['class' => 'form-control']) !!}
                     </div> 
                          <div class="form-group"> 
