...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'customers_name_en' , {
      ...
      var customers_name_en = CKEDITOR.instances.customers_name_en.getData();
              ...
              url:"{{ url('admin/customers')}}/{{$customers->id}}",
              dataType:'json',
              type:'post',
              data:{
        "_token": "{{ csrf_token() }}",
        "customers_name_en": customers_name_en,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.customers') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/customers','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">
 
        
          @include('Admin.customers.updattabs.photo')
               <div class="form-group"> 
