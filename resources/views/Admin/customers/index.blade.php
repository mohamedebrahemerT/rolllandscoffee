  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> {{trans('admin.customers') }}</li>
      </ol>
    ...
    <!-- /.content -->
        ...
        {!! Form::open(array('url' => 'admin/customers/destory/all','method'=>'delete', 'id' => 'fromdata')) !!}
      
     {!! $dataTable->table([

                   'class'=>'class="dataTable table table-bordered table-striped table-hover'
      ],true) !!}
      {!! Form::close()  !!}
