  ...
  <script type="text/javascript">   
         ...
         $('#dropzone_main_photo').dropzone({
            ...
            url:'{{ url("admin/update_img_dropzon_customers/img/".$customers->id) }}',
            paramName:'file',
            //uploadMultiple:true,
            maxFile:0,
            maxFilesize:3,
            ...
            removedfile:function(file)
            {
              ...
              $.ajax({
                dataType:'json',
                type:'post',
                url:'{{ url("admin/delete_img_dropzon_customers/img/".$customers->id)}}',
                data:{
                  _token:'{{ csrf_token() }}',
                },
...
this.options.thumbnail.call(this,mock,"{{Storage::url($customers->photo)}}" );
               $('.dz-progress').remove();
               @endif
  ...
  <div id="menu5" class="tab-pane fade in active">
      <h3>{{trans('admin.photo')}} witdth:180 * height:60</h3>
